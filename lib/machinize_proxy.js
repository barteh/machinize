...
function () {
  _createClass(Machinize, [{
    ...
    value: function init(fsm) {
      ...
      fsm["startAll"] = function (func) {
        ...
        for (var _i4 = 0; _i4 < fsm.instanceList.length; _i4++) {
  ...
  function Machinize(fsm, insData) {
    ...
    for (var _s in this.states) {
      ...
      this.states[_s].whenEnter = new Promise(function (res, rej) {});
      this.states[_s].whenExit = new Promise(function (res, rej) {});
    }
  ...
  _createClass(Machinize, [{
    ...
    value: function machinize(oo) {
      ...
      var o = {};
      var pro = new Proxy(o, {
        set: function set(tar, k, v) {
          if (typeof tar[k] === "number") tar[k] = Number(v);else tar[k] = v;
      ...
      for (var _k in this._data) {
        if (!o[_k]) {
          o[_k] = this._data[_k];
          o.$data[_k] = this._data[_k];
        }
      }

      for (var _k2 in this.parameters) {
        if (!o[_k2]) {
          o[_k2] = this.parameters[_k2];
        }
      ...
      if (this.computed) {
        ...
        var _loop5 = function _loop5(cmp) {
          // o.$computed[cmp]=cmp;
      ...
      o["$observable"] = function (st, fromst) {
        var from = undefined;
        var to = undefined;
    ...
    value: function refreshConditions(o) {
      ...
      if (!o.$isRunning) return;
      if (o.$lock) return; //console.log(778,o.name)
